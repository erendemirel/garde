...
Post-bring-up / post-deploy smoke checks for an active-active cluster: mesh
reachability, provider preflight, health/roles, traffic location, and optional
auth / public HTTPS / service-listener checks.

**Impact: none**. Safe after every deploy.
...
| `02-health-and-roles.sh` | `healthcheck.sh --all`; app `/ready`; Vault quorum |
